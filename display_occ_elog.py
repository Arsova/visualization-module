...
circle = Circle(x="lon_elog", y="lat_elog", size=12, fill_color="blue", fill_alpha=0.5, line_color=None, name="elog locations")
glyph_circle = plot.add_glyph(source_elog_original, circle)
